...
const zonas: Zona[] = [
  // Loreto
  { id: "zona-maynas", nombre: "Maynas", sectorId: "sector-loreto" },
  { id: "zona-mariscal-ramon-castilla", nombre: "Mariscal Ramón Castilla", sectorId: "sector-loreto" },
  { id: "zona-requena", nombre: "Requena", sectorId: "sector-loreto" },
  { id: "zona-loreto", nombre: "Loreto", sectorId: "sector-loreto" },
  { id: "zona-ucayali", nombre: "Ucayali", sectorId: "sector-loreto" },
  { id: "zona-alto-amazonas", nombre: "Alto Amazonas", sectorId: "sector-loreto" },
  { id: "zona-putumayo", nombre: "Putumayo", sectorId: "sector-loreto" },
  { id: "zona-datem-del-maranon", nombre: "Datem del Marañón", sectorId: "sector-loreto" },
  // Amazonas
  { id: "zona-condorcanqui", nombre: "Condorcanqui", sectorId: "sector-amazonas" },
  { id: "zona-bagua", nombre: "Bagua", sectorId: "sector-amazonas" },
  { id: "zona-utcubamba", nombre: "Utcubamba", sectorId: "sector-amazonas" },
  { id: "zona-bongara", nombre: "Bongará", sectorId: "sector-amazonas" },
  { id: "zona-chachapoyas", nombre: "Chachapoyas", sectorId: "sector-amazonas" },
  // Cajamarca
  { id: "zona-san-ignacio", nombre: "San Ignacio", sectorId: "sector-cajamarca" },
  { id: "zona-jaen", nombre: "Jaén", sectorId: "sector-cajamarca" },
  { id: "zona-cutervo", nombre: "Cutervo", sectorId: "sector-cajamarca" },
  { id: "zona-chota", nombre: "Chota", sectorId: "sector-cajamarca" },
  { id: "zona-santa-cruz", nombre: "Santa Cruz", sectorId: "sector-cajamarca" },
  { id: "zona-hualgayoc", nombre: "Hualgayoc", sectorId: "sector-cajamarca" },
  { id: "zona-cajamarca", nombre: "Cajamarca", sectorId: "sector-cajamarca" },
  { id: "zona-cajabamba", nombre: "Cajabamba", sectorId: "sector-cajamarca" },
  { id: "zona-san-marcos", nombre: "San Marcos", sectorId: "sector-cajamarca" },
  { id: "zona-san-miguel", nombre: "San Miguel", sectorId: "sector-cajamarca" },
  { id: "zona-celendin", nombre: "Celendín", sectorId: "sector-cajamarca" },
  { id: "zona-contumaza", nombre: "Contumazá", sectorId: "sector-cajamarca" },
  { id: "zona-san-pablo", nombre: "San Pablo", sectorId: "sector-cajamarca" },
]
